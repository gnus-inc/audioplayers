...
import 'api/audio_position.dart';
...
class AudioPlayer {
  ...
  static Future<void> _doHandlePlatformCall(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case 'audio.onSeekable':
        final seekable = callArgs['value'] as bool;
        player._seekableController.add(seekable);
        break;
      ...
      case 'audio.onGotPlayTrackCommand':
        player.notificationService.notifyPlayTrack();
        break;
      case 'audio.onGotPauseTrackCommand':
        player.notificationService.notifyPauseTrack();
        break;
  ...
  Future<void> dispose() async {
    ...
    if (!_seekableController.isClosed) {
      futures.add(_seekableController.close());
    }
